...
from app.core.telemetry import get_total_tokens, log_metric
from app.models.schemas import APIResponse, FanRequest
...
async def _cached_genai_call(prompt: str, timeout: float = 60.0) -> dict:
    ...
    res = await asyncio.wait_for(
        client.aio.models.generate_content(model="gemini-3.5-flash", contents=[prompt]),
        timeout=timeout,
    )
...
async def handle_fan_query(request: Request, payload: FanRequest) -> APIResponse:
    ...
    try:
        ...
        logger.warning(
            "Timeout while processing fan query, falling back to degraded state."
        )
        latency_milliseconds = (time.perf_counter() - start_time_counter) * 1000
        log_metric(
            endpoint="/fan/query",
...
async def execute_ops_dispatch(request: OpsDispatchRequest) -> dict[str, str]:
    ...
    try:
        return {
            "status": "Success",
            "dispatched_resource": request.resource,
...
async def generate_text_to_speech(request: TTSRequest) -> Any:
    ...
    try:
        ...
        synthesized_audio_response = tts_client.synthesize_speech(
            input=synthesis_input_config,
            voice=voice_selection_config,
            audio_config=audio_encoding_config,
        )

        return Response(
            content=synthesized_audio_response.audio_content, media_type="audio/mp3"
        )
    except Exception as general_error:
...
@limiter.limit("5/minute")
async def handle_fan_assist(
    request: Request, payload: FanAssistRequest
) -> dict[str, Any]:
    """
                    ...
                    "matches": [
                        {
                            ...
                            "home": {"name": "MAR", "flag": "🇲🇦", "score": "3"},
                            "away": {"name": "CAN", "flag": "🇨🇦", "score": "0"},
                        },
                        {
                            "id": 90,
                            "date": "Jul 04",
                            "venue": "Lumen Field, Seattle",
                            "home": {"name": "FRA", "flag": "🇫🇷", "score": "1"},
                            "away": {"name": "PAR", "flag": "🇵🇾", "score": "0"},
                        },
                        {
                            "id": 91,
                            "date": "Jul 05",
                            "venue": "Levi's Stadium, San Francisco",
                            "home": {"name": "NOR", "flag": "🇳🇴", "score": "2"},
                            "away": {"name": "BRA", "flag": "🇧🇷", "score": "1"},
                        },
                        {
                            "id": 92,
                            "date": "Jul 05",
                            "venue": "SoFi Stadium, Los Angeles",
                            "home": {"name": "ENG", "flag": "🏴󠁧󠁢󠁥󠁮󠁧󠁿", "score": "3"},
                            "away": {"name": "MEX", "flag": "🇲🇽", "score": "2"},
                        },
                        {
                            "id": 93,
                            "date": "Jul 06",
                            "venue": "NRG Stadium, Houston",
                            "home": {"name": "ESP", "flag": "🇪🇸", "score": "1"},
                            "away": {"name": "POR", "flag": "🇵🇹", "score": "0"},
                        },
                        {
                            "id": 94,
                            "date": "Jul 06",
                            "venue": "AT&T Stadium, Dallas",
                            "home": {"name": "BEL", "flag": "🇧🇪", "score": "4"},
                            "away": {"name": "USA", "flag": "🇺🇸", "score": "1"},
                        },
                        {
                            "id": 95,
                            "date": "Jul 07",
                            "venue": "Mercedes-Benz Stadium, Atlanta",
                            "home": {"name": "ARG", "flag": "🇦🇷", "score": "3"},
                            "away": {"name": "EGY", "flag": "🇪🇬", "score": "2"},
                        },
                        {
                            "id": 96,
                            "date": "Jul 07",
                            "venue": "Hard Rock Stadium, Miami",
                            "home": {"name": "SUI", "flag": "🇨🇭", "score": "0(4)"},
                            "away": {"name": "COL", "flag": "🇨🇴", "score": "0(3)"},
                        },
                    ],
                },
                {
                    ...
                    "matches": [
                        {
                            ...
                            "home": {"name": "FRA", "flag": "🇫🇷", "score": "2"},
                            "away": {"name": "MAR", "flag": "🇲🇦", "score": "0"},
                        },
                        {
                            "id": 98,
                            "date": "Jul 10",
                            "venue": "Lincoln Financial Field, Philadelphia",
                            "home": {"name": "ESP", "flag": "🇪🇸", "score": "2"},
                            "away": {"name": "BEL", "flag": "🇧🇪", "score": "1"},
                        },
                        {
                            "id": 99,
                            "date": "Jul 11",
                            "venue": "Arrowhead Stadium, Kansas City",
                            "home": {"name": "ENG", "flag": "🏴󠁧󠁢󠁥󠁮󠁧󠁿", "score": "2"},
                            "away": {"name": "NOR", "flag": "🇳🇴", "score": "1"},
                        },
                        {
                            "id": 100,
                            "date": "Jul 11",
                    ...
                    "matches": [
                        {
                            ...
                            "venue": "AT&T Stadium, Dallas",
                            "home": {"name": "ESP", "flag": "🇪🇸", "score": "2"},
                            "away": {"name": "FRA", "flag": "🇫🇷", "score": "0"},
                        },
                        {
                            "id": 102,
                            "date": "Jul 15",
                            "venue": "Mercedes-Benz Stadium, Atlanta",
                            "home": {"name": "ARG", "flag": "🇦🇷", "score": "2"},
                            "away": {"name": "ENG", "flag": "🏴󠁧󠁢󠁥󠁮󠁧󠁿", "score": "1"},
                        },
                    ],
                },
                {
                    ...
                    "matches": [
                        {
                            ...
                            "home": {"name": "ESP", "flag": "🇪🇸", "score": "-"},
                            "away": {"name": "ARG", "flag": "🇦🇷", "score": "-"},
                        }
                    ],
                },
            ]
